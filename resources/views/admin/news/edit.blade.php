        ...
        <section class="content">
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <form class="form-group" action="{{ route('news.update',$new->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="tab-content">
                            @include('admin.news.tabs_edit.content')
                            @include('admin.news.tabs_edit.setting')
                            @include('admin.news.tabs_edit.categories_countries')
                        </div>
                        <div class="form-group">
                            <button class="btn btn-info" type="submit"><i class="fa fa-plus"></i> @lang('admin.add_and_continue')</button>
                            <button name="save_close" class="btn btn-success" type="submit"><i class="fa fa-plus"></i> @lang('admin.add_and_close')</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        $('.parent_id').on('change',function () {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('.nothing').append('<option value="">@lang('admin.no_sub_category')</option>');
                },
                error:function (e,z) {
